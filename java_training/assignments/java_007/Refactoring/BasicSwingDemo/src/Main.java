...
public class Main {
	...
	public static JFrame setFrameStuff(JFrame frm, int width, int height, int onExit, String label) {
		...
		LambdaFunction lambdaFunction1 = () -> frm.setDefaultCloseOperation(onExit);
	...
	public static void main(String args[]) {
		...
		- The “invokeLater” method will ensure the thread is 
		  scheduled at some point in Java’s scheduler.		- The class Main and its public static void main are 
